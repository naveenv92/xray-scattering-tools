...
### Convert Binary to TIFF &ndash; `convert-binary-to-tiff.py`   
...
### GIWAXS Image Simulator &ndash; `giwaxs-image-simulator.py`  
...
### X-Ray Scattering Analyzer &ndash; `xrs-analyzer.py`   
